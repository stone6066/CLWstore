...
@interface ChooseCarTypeViewController () <UITableViewDataSource, UITableViewDelegate, TableViewSectionIndexTitlesViewDelegate>
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([tableView isEqual:_carTypeListTableView]) {
        ...
        ReleaseRequireModel *model = self.detailsModelArr[indexPath.row];
        [self post:model andDetailsModel:_carModel];
    }
}
- (void) post:(id)chooseCarModel andDetailsModel:(id)detailsModel {
    [self.navigationController popViewControllerAnimated:YES];
    [kNotiCenter postNotificationName:@"chooseModel" object:nil userInfo:@{@"detailstype":chooseCarModel, @"cartype":detailsModel}];
}
